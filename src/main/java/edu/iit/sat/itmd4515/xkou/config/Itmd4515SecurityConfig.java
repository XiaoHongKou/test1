 ...
 */
package edu.iit.sat.itmd4515.xkou.config;
...
@Named
@ApplicationScoped
@DeclareRoles({Itmd4515SecurityRoles.ADMIN_ROLE, Itmd4515SecurityRoles.TEACHER_ROLE, Itmd4515SecurityRoles.BOOK_ROLE})
